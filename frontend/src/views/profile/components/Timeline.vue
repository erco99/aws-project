...
<script>
  ...
  export default {
    ...
    mounted() {
      // Test for retrieve played bookings
      this.$store.dispatch("user/getAllPlayedBookings").then((playedBookings) => {
        this.option.series[0].data = playedBookings;
      });
    }
  }
</script>
